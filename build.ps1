...
$refNames = @(
    ...
    "UnityEngine.AssetBundleModule.dll", "UnityEngine.ParticleSystemModule.dll", "UnityEngine.AudioModule.dll", "UnityEngine.UI.dll", "Unity.TextMeshPro.dll", "UnityEngine.UIModule.dll"
)
